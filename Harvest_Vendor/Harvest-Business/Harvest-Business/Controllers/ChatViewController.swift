...
//  Harvest-Business
//
//  Created by Zixuan Li on 2021/3/27.
//
...
class ChatViewController: MessagesViewController, MessagesDataSource {
    ...
    var user2Img_url = String()
    var user2ID = String()
    var user2PhoneNum = String()
...
extension ChatViewController: InputBarAccessoryViewDelegate {
    ...
    func inputBar(_ inputBar: InputBarAccessoryView, didPressSendButtonWith text: String) {
        ...
        let message = Message(id: UUID().uuidString, content: text, created: Timestamp(), senderID: selfSender.uid, senderName: "Irene driver") // TODO: fix name
